...
#colocar a câmera no lugar correto
#tirar foto das opções de itens (inicialmente 2)
#salvar cada opção(foto) em uma variável
#parametrizar/vetorizar as 2 imagens e salvar em uma nova variável
#receber a nova foto, vetorizar/parametrizar
#comparar com as antigas variáveis e verificar com qual se parece mais
#tracker csrt
...
foto_dois=None
foto_tres=None
i=2              # 0 -> printar tudo / 1 -> printar uma / 2 -> printar nenhuma
...
if cam.isOpened():
    while online == True:
        ...
        img_reference1 = cv2.imread("foto1.png", cv2.IMREAD_GRAYSCALE)      #IMAGEM 1
        img_reference2 = cv2.imread("foto2.jpg", cv2.IMREAD_GRAYSCALE)      #IMAGEM 2
